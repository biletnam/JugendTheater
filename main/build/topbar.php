<nav class="fh5co-nav-style-1" role="navigation" data-offcanvass-position="fh5co-offcanvass-left">
  <div class="container">
    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12 fh5co-logo">
      ...
      <a href="https://www.jugendtheaterfestival.ch/de"><?php gCT('Jugend Theater Festival Schweiz');?></a>
    </div>
    ...
    <div class="col-lg-3 col-md-4 col-sm-4 text-right fh5co-link-wrap hidden-xs">
      ...
      <li class="dropdown top-dd">
        <a href="#" class="dropdown-toggle useFontStrict" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><i class="fa fa-globe" aria-hidden="true"> <?php gCT("Sprachen");?></i></a>
        <ul class="dropdown-menu">
          <!-- REVIEW: Hard Coded Langs -->
            <li><a href="<?php echo $oldUrl;?>&newln=de"><?php gCT("Deutsch");?></a></li>
            <li><a href="<?php echo $oldUrl;?>&newln=fr"><?php gCT("Französisch");?></a></li>
            <li><a href="<?php echo $oldUrl;?>&newln=it"><?php gCT("Italienisch");?></a></li>
        </ul>
      </li>
    </ul>
      <ul class="fh5co-special hidden-xs" data-offcanvass="yes">
        <?php if(!$loggedIn){ ?>
              ...
              <li id="loginBtn"><a href="#" data-toggle="modal" data-target="#loginmodal"></i> <?php gCT("Login");?></a></li>
              <li id="registerBtn"><a href="#" data-toggle="modal" data-target="#registermodal" class="call-to-action"><?php gCT("Register");?></a></li>
        <?php } ?>
