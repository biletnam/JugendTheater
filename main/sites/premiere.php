...
?>
    ...
    <div class="fh5co-cover fh5co-cover-style-2 js-full-height" data-stellar-background-ratio="0.5" data-next="yes"  style="background-image: url(<?php echo $DomainUrlPath;?>/uploads/<?php echo $row['ID'].$row['Bilder']; ?>);">
			...
			<div class="fh5co-cover-text">
                ...
                <p class="wow fadeInUp" data-wow-duration="1s" data-wow-delay=".6s"><a href="<?php echo $DomainUrlPath;?>/" class="btn btn-primary btn-outline btn-lg"><?php gCT("Zurück zur Auswahl");?></a></p>
							</div>
						</div>
					</div>
				</div>
      ...
      <div class="container">
        <div class="row p-b">
          <div class="text-center">
                 ...
                 <div class="dz-hide"><div class="dz-hide-sub">
                   <div class="dz-hide-img">
                     <a href="<?php echo $fname; ?>" download>
                       <img data-dz-thumbnail  src="<?php $ext = pathinfo($fname, PATHINFO_EXTENSION); if($ext == "pdf"){echo $DomainUrlPath . "/images/edit/pdf.png";}else{echo $fname;}?>">
			...
			<div class="fh5co-counter-style-2" style="background-image: url(<?php echo $DomainUrlPath;?>/uploads/<?php echo $row['ID'].$row['Bilder']; ?>);" data-stellar-background-ratio="0.5">
			<div class="fh5co-overlay"></div>
			<div class="container">
