...
<div class="fh5co-project-style-2">
  ...
  <div class="fh5co-projects">
    ...
    <ul id="homePrems">
      ...
      <li class="wow fadeInUp col-md-4" style="background-image: url(https://test.jugend-theater.ch/uploads/small/<?php  echo $row['ID'].$row['Bilder']; ?>);" data-wow-duration="1s" data-wow-delay=".8s" data-stellar-background-ratio="0.5">
