  ...
  <div class="container">
    <div class="row p-b">
      <div class="col-md-6 col-md-offset-3 text-center">
        ...
        <p class="wow fadeInUp" data-wow-duration="1s" data-wow-delay=".4s">Warten auf Aktivierung</p>
      </div>
    </div>
  </div>

  <div class="fh5co-projects">
    <div class="container premiere-container">
    <div class="row">
    <ul id="profPrems">
    ...
    <p id="noPremtxt" class="wow fadeInUp col-md-12 text-center <?php if($tour != 0){echo 'invisibleStrict'; } ?>" data-wow-duration="1s" data-wow-delay=".8s">Keine Anmeldungen</p>
  </div>
</div>
</div>
</div>
...
<div class="fh5co-project-style-2">
  <div class="container">
    <div class="row p-b">
      <div class="col-md-6 col-md-offset-3 text-center">
        <p class="wow fadeInUp" data-wow-duration="1s" data-wow-delay=".4s">Aktiviert</p>
      </div>
    </div>
  </div>
  ...
  <div class="fh5co-projects">
    ...
    <p id="noPremtxtActive" class="wow fadeInUp col-md-12 text-center <?php if($tour != 0){echo 'invisibleStrict'; } ?>" data-wow-duration="1s" data-wow-delay=".8s">Keine Premieren aktiv</p>
  </div>
</div>
</div>
</div>
...
<div class="container">
  <div class="row p-b">
    <div class="col-md-6 col-md-offset-3 text-center">
      <p class="wow fadeInUp" data-wow-duration="1s" data-wow-delay=".4s">Abgelehnt</p>
    </div>
  </div>
</div>
...
<div class="fh5co-projects">
  ...
  <p id="noPremtxtInv" class="wow fadeInUp col-md-12 text-center <?php if($tour != 0){echo 'invisibleStrict'; } ?>" data-wow-duration="1s" data-wow-delay=".8s">Keine Premieren abgelehnt</p>
</div>
</div>
</div>
