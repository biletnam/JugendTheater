<?php
  function changePremDB($fileType){
    global $user;
    global $DBconn;
    $sql = "UPDATE premieren SET Produktion='".gMS($_POST['name'])."',Spieler='".gMS($_POST['spieler'])."',PremiereDatum='".gMS($_POST['datum'])."',Ort='".gMS($_POST['ort'])."',Beschrieb='".gMS($_POST['beschrieb'])."',Video='".gMS($_POST['video'])."',Bilder='".$fileType."' WHERE ID=".$_POST['id'];
